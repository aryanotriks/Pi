...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('https://www.facebook.com/sayyed.302_ew_confirmation=1 ')
    else:
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.facebook.com/sayyed.302?sub_confirmation=1')
...
def pilih_super():
	...
	p.map(main, id)
	print 42*"\033[1;96m="
	print '\033[1;96m[\033[1;97m✓\033[1;96m] \033[1;92mProcess Has Been Completed donot say me Thank You♥️ \033[1;97m....'
